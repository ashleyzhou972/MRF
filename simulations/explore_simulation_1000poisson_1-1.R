...
if (!load_y) {
  ...
  set.seed(266)
  y1<-simulate_y_poisson_ms(1000, sub_neighbor, param[1], param[2], param[3], 3, 5000)
  y4<-simulate_y_poisson_mvn(1000, sub_neighbor, param[1], param[2], param[3], 3)
  set.seed(267)
  y2<-simulate_y_poisson_ms(1000, sub_neighbor,param[1], param[2], param[3],3, 5000)
  y5<-simulate_y_poisson_mvn(1000, sub_neighbor, param[1], param[2], param[3], 3)
  set.seed(268)
  y3<-simulate_y_poisson_ms(1000, sub_neighbor, param[1], param[2], param[3],3,5000)
  y6<-simulate_y_poisson_mvn(1000, sub_neighbor,param[1], param[2], param[3], 3)
