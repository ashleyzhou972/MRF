...
vars[4,]<-c(0.7, 0.15, 0.15, 0.12)
vars[5,]<-c(0.7, 0.15, 0.2, 0.12) 
vars[6,]<-c(0.7, 0.15, 0.15, 0.12)
for (i in 4:length(y)) {
  n = nrow(y[[i]])
  cat("data size:", n,"\n")
...
#save ret workspace
code2 = "exp2"
save(ret,vars, inis1, param, file = paste('./returned_workspace_',param[1], '_', param[2],'_', param[3],'_', code2,'.RData', sep=""))
