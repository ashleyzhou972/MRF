 ...
 *
**/
void mean_mu(int size_w, double *w, int **neighbor, double alpha, double eta)
{	
	temp_vec=matrix_vector_multiplication();
	temp_vec2 = cblas_dxapy(size_w, eta, temp_vec, 1, zero_array, 1);
	mu = cblas_dxapy(size_w, alpha, one_array, 1, temp_vec2, 1);
}
/**
